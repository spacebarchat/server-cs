...
public static class Rights
{
    ...
    public static int
        MANAGE_MESSAGES = 3; // Can't see other messages but delete/edit them in channels that they can see
    ...
    public static int ADD_MEMBERS = 8;

    public static int BYPASS_RATE_LIMITS = 9;
    public static int CREATE_APPLICATIONS = 10;

    public static int
        CREATE_CHANNELS = 11; // can create guild channels or threads in the guilds that they have permission
