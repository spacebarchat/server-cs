...
public class DbInstantiationTests
{
    ...
    public void GetNewDbTest()
    {
        try
        {
            var db = Db.GetNewDb(DbConfig.FromEnv("GetNewDb".Replace("GetNew", "Get").Replace("Get", "FC_CS_UNIT_TEST_")
                .ToUpper()));
        }
        catch (Exception e)
        {
    ...
    public void GetNewMysqlTest()
    {
        try
        {
            var db = Db.GetNewMysql(DbConfig.FromEnv("GetNewMysql".Replace("GetNew", "Get")
                .Replace("Get", "FC_CS_UNIT_TEST_").ToUpper()));
        }
        catch (Exception e)
        {
    ...
    public void GetNewPostgresTest()
    {
        try
        {
            var db = Db.GetNewPostgres(DbConfig.FromEnv("GetNewPostgres".Replace("GetNew", "Get")
                .Replace("Get", "FC_CS_UNIT_TEST_").ToUpper()));
        }
        catch (Exception e)
        {
    ...
    public void GetSqliteTest()
    {
        try
        {
            var db = Db.GetSqlite(DbConfig.FromEnv("GetSqlite".Replace("GetNew", "Get")
                .Replace("Get", "FC_CS_UNIT_TEST_").ToUpper()));
        }
        catch (Exception e)
        {
    ...
    public void GetInMemoryDbTest()
    {
        try
        {
            var db = Db.GetInMemoryDb(DbConfig.FromEnv("GetInMemoryDb".Replace("GetNew", "Get")
                .Replace("Get", "FC_CS_UNIT_TEST_").ToUpper()));
        }
        catch (Exception e)
        {
