...
public class ZlibTests
{
    ...
    private byte[] knownCompressed = {0x78, 0x9c, 0xab, 0xe6, 0x52, 0x50, 0x50, 0xca, 0x2f, 0x50, 0xb2, 0x52, 0x30, 0x34, 0xe4, 0xaa, 0x05, 0x00, 0x17, 0xb7, 0x03, 0x2c };
    private byte[] knownDecompressed = {0x7b, 0x0a, 0x20, 0x20, 0x22, 0x6f, 0x70, 0x22, 0x3a, 0x20, 0x31, 0x31, 0x0a, 0x7d};
    ...
    {
        Ionic.Zlib.ZlibStream zs = new Ionic.Zlib.ZlibStream(new MemoryStream(knownDecompressed), Ionic.Zlib.CompressionMode.Compress, Ionic.Zlib.CompressionLevel.Default);
